$(function(){
	...
	$('.mNav').on('click',function(event){
		...
		if($(this).attr('isOpen')=='false')
		{
			...
			$('.navMore').css('background-image','url('+img_link+'img/add.png)');
		}
	});
	$('.navMore').on('click',function(event){
		...
		if($(this).attr('isOpen')=='false')
		{
			...
			$(this).css('background-image','url('+img_link+'img/none.png)');
		}else{
			$(this).attr('isOpen',false);			
			$(this).next('ul').stop().slideUp(500);
			$(this).css('background-image','url('+img_link+'img/add.png)');
		}
	});
