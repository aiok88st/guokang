jQuery.fn.areaSelector = function(argument) {
       ...
       areaData = argument;
        ...
        region: {
            ...
            state: [{
                name: '北京',
                code: '01',
                city: [{ name: '东城区', code: '01' }, { name: '西城区', code: '02' }, { name: '崇文区', code: '03' }, { name: '宣武区', code: '04' },
                    { name: '朝阳区', code: '05' }, { name: '丰台区', code: '06' }, { name: '石景山区', code: '07' }, { name: '海淀区', code: '08' },
                    { name: '门头沟区', code: '09' }, { name: '房山区', code: '11' }, { name: '通州区', code: '12' }, { name: '顺义区', code: '13' },
                    { name: '昌平区', code: '14' }, { name: '大兴区', code: '15' }, { name: '怀柔区', code: '16' }, { name: '平谷区', code: '17' },
                    { name: '密云县', code: '28' }, { name: '延庆县', code: '29' }
                ]
            }]
        }
        }, {
        region: {
            ...
            state: [{
                name: '天津',
                code: '01',
                city: [{ name: '和平区', code: '01' }, { name: '河东区', code: '02' }, { name: '河西区', code: '03' }, { name: '南开区', code: '04' },
                    { name: '河北区', code: '05' }, { name: '红桥区', code: '06' }, { name: '塘沽区', code: '07' }, { name: '汉沽区', code: '08' },
                    { name: '大港区', code: '09' }, { name: '东丽区', code: '10' }, { name: '西青区', code: '11' }, { name: '津南区', code: '12' },
                    { name: '北辰区', code: '13' }, { name: '武清区', code: '14' }, { name: '宝坻区', code: '15' }, { name: '宁河县', code: '21' },
                    { name: '静海县', code: '23' }, { name: '蓟县', code: '25' }
                ]
            }]
        }
        }, {
    ...
    function setCoordinate() {
        ...
        $("#" + contentId).offset({ top: offsetX-21, left: offsetY });
    }
    ...
    function replyOperation() {
        ...
        $('#' + contentId + ' .data_city li').on('click', function() {
            areaCode = $(this).find('input').val();
            $("#" + contentId).toggleClass('isBlock');
            $('#' + thisId).val(theRegion + ' / ' + theCity + ' / ' + $(this).children('a').text());
            $('#'+thisId+'_input').val(regionCode+'|'+cityCode+'|'+areaCode);
        })
    }
