...
if (!$smarty->is_cached('famousOne.dwt', $cache_id))
{
    //分类
    $sql = 'SELECT cat_id, cat_name, parent_id FROM  ecs_article_cat WHERE parent_id = 18 ORDER BY sort_order ASC';
    $catlist = $db->getAll($sql);
    $smarty->assign('catlist',           $catlist);
    $smarty->assign('cat_id',    $cat_id);
    //面包屑
    $cat = get_cat_info($cat_id);
    $url_html = '<li><a href="./index.php">首页 &gt;</a></li><li><a href="brand_news.php?id=19">品牌体系 &gt;</a></li><li><a href="javascript:;">'.$cat['cat_name'].'</a></li>';
    ...
    $pager = get_pager('brand_news.php', array('id'=>$cat_id), $count, $page,$size);
...
$smarty->display('famousOne.dwt', $cache_id);
