...
if (!$smarty->is_cached('famousTwo.dwt', $cache_id))
{
    //最新新闻
    ...
    if (!empty($next_article))
    {
        ...
        $next_article['url'] = build_uri('brand_news_detail', array('aid'=>$next_article['article_id']), $next_article['title']);
    }else{
        $next_article = '';
    }
    ...
    if (!empty($prev_aid))
    {
        ...
        $prev_article['url'] = build_uri('brand_news_detail', array('aid'=>$prev_article['article_id']), $prev_article['title']);
    }else{
        $prev_article = '';
    }
...
{
    $smarty->display('famousTwo.dwt', $cache_id);
}
else
{
    $smarty->display('famousTwo.dwt', $cache_id);
